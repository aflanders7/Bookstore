...
app.post('/add-merch-ajax', function(req, res) 
{
    ...
    query1 = `INSERT INTO Merchandise (merchName, merchPrice, merchQuantity) VALUES ('${data.merchName}', '${data.merchPrice}', ${data.merchQuantity}`;
    db.pool.query(query1, function(error, rows, fields){
